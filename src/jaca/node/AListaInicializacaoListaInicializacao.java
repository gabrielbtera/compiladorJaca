...
{
    private PPinicializacao _esq_;
    private TVirgula _virgula_;
    private PListaInicializacao _dir_;
    ...
    public AListaInicializacaoListaInicializacao(
        @SuppressWarnings("hiding") PPinicializacao _esq_,
        @SuppressWarnings("hiding") TVirgula _virgula_,
        @SuppressWarnings("hiding") PListaInicializacao _dir_)
    {
        // Constructor
        setEsq(_esq_);
    ...
    public PPinicializacao getEsq()
    {
        return this._esq_;
    }

    public void setEsq(PPinicializacao node)
    {
        if(this._esq_ != null)
        {
    ...
    public PListaInicializacao getDir()
    {
        return this._dir_;
    }

    public void setDir(PListaInicializacao node)
    {
        if(this._dir_ != null)
        {
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        {
            setEsq((PPinicializacao) newChild);
            return;
        }
        ...
        {
            setDir((PListaInicializacao) newChild);
            return;
        }
