...
public final class ADecConsListaDecCons extends PListaDecCons
{
    private PDecCons _decCons_;

    public ADecConsListaDecCons()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADecConsListaDecCons(
    ...
    {
        ((Analysis) sw).caseADecConsListaDecCons(this);
    }
