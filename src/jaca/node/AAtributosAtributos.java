...
public final class AAtributosAtributos extends PAtributos
{
    ...
    public AAtributosAtributos(
        @SuppressWarnings("hiding") PDec _esq_,
        @SuppressWarnings("hiding") PAtributos _dir_)
    {
        // Constructor
        setEsq(_esq_);
    ...
    public PAtributos getDir()
    {
        return this._dir_;
    }

    public void setDir(PAtributos node)
    {
        if(this._dir_ != null)
        {
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        {
            setEsq((PDec) newChild);
            return;
        }

        if(this._dir_ == oldChild)
        {
            setDir((PAtributos) newChild);
            return;
        }
